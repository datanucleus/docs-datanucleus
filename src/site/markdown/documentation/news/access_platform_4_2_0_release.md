<head><title>AccessPlatform 4.2.0.RELEASE</title></head>

# DataNucleus AccessPlatform 4.2.0.RELEASE

<div id="dzone_vote_widget" style="float: left; margin-right: 8px;">
    <script type="text/javascript">var dzone_title = 'DataNucleus AccessPlatform 4.2.0.RELEASE Released';</script>
    <script type="text/javascript">var dzone_url = 'http://www.datanucleus.org/documentation/news/access_platform_4_2_0_release.html';</script>
    <script type="text/javascript" language="javascript" src="http://widgets.dzone.com/widgets/zoneit.js"></script>
</div>

__9th October 2015__ - DataNucleus AccessPlatform 4.2.0.RELEASE ("Planck") is released.
...
DataNucleus AccessPlatform 4.2 includes the following features relative to version 4.1
...
This release includes the following changes over the previous release (4.2.0.M3)
