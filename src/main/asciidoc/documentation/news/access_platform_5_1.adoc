...
* __5.1.12 September/October 2018?__


== DataNucleus AccessPlatform 5.1.11

__Aug 4th 2018__ : _Version 5.1.11_ includes the following changes
...
* https://github.com/datanucleus/datanucleus-api-jdo/issues/78[datanucleus-api-jdo-78] - JDOQLTyped : handle situation of result being candidate (backport)
* https://github.com/datanucleus/datanucleus-api-jdo/issues/79[datanucleus-api-jdo-79] - JDOQLTyped : support Expression.cast (backport)
* https://github.com/datanucleus/datanucleus-api-jdo/issues/80[datanucleus-api-jdo-80] - Implement StringExpression.add(String) (backport)
...
* https://github.com/datanucleus/datanucleus-core/issues/305[datanucleus-core-305] - When updating L2 cached object, make sure that any versioned field is also updated (backport)
* https://github.com/datanucleus/datanucleus-api-jpa/issues/108[datanucleus-api-jpa-108] - MetaModel SingularAttribute.isOptional can give misleading info (backport)
