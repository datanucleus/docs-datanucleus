...
2. Search https://groups.io/g/datanucleus/[Groups.IO], https://gitter.im/datanucleus/Lobby[Gitter] or http://www.stackoverflow.com[Stackoverflow] for a similar situation 
...
_You could also try https://stackoverflow.com/questions/tagged/datanucleus[StackOverflow] but note that we do not provide support there_.
