...
You can also contribute via either the http://forum.datanucleus.org[Forum] or by raising an issue against the DataNucleus plugin in question.
...
In terms of automated code quality tool reviews, you can see the results of http://sonar.datanucleus.org[Sonar] and https://lgtm.com/search?q=datanucleus[LGTM.com].
