...
* __Answer questions on https://groups.io/g/datanucleus/[Groups.IO] or https://gitter.im/datanucleus/Lobby[Gitter]__. 
...
You can also contribute via either https://groups.io/g/datanucleus/[Groups.IO] or https://gitter.im/datanucleus/Lobby[Gitter] or by raising an issue against the DataNucleus plugin in question.
...
NOTE: All code must be compilable using JDK 1.8 currently.
